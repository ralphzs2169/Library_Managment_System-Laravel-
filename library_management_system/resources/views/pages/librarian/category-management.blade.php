                        ...
                        <div class="flex items-center justify-between px-4 py-2">
                            ...
                            <div class="flex space-x-2 items-center">
                                ...
                                <div class="relative inline-block">
                                    <button id="delete-category-{{ $category->id }}" 
                                        class="flex items-center px-5 py-1.5 shadow-sm rounded-lg text-sm transition-all {{ $hasGenres ? 'bg-[#CF3030] opacity-55 cursor-not-allowed' : 'bg-[#CF3030] cursor-pointer hover-scale-sm hover:bg-[#B82828]' }}"
                                        {{ $hasGenres ? 'disabled' : '' }}
                                        data-has-genres="{{ $hasGenres ? 'true' : 'false' }}">
