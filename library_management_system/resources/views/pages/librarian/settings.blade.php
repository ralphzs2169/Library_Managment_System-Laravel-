        ...
        <form id="settings-form" class="space-y-6" novalidate>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Rate Per Day -->
                    <div class="field-container flex flex-col">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Overdue Rate (₱/day)</label>
                    ...
                    <!-- Max Penalty -->
                    <div class="field-container flex flex-col">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Maximum Penalty (₱)</label>
                    ...
                    <div class="field-container flex flex-col">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Lost Book Multiplier</label>
                    ...
                    <div class="field-container flex flex-col">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Damaged Book Multiplier</label>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="field-container flex items-center h-full pt-6">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <span class="text-sm font-semibold text-gray-700 group-hover:text-gray-900">Enable Borrower Notifications</span>
                        </label>
                    </div>
                    ...
                    <div class="field-container flex items-center h-full pt-6">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <span class="text-sm font-semibold text-gray-700 group-hover:text-gray-900">Show Overdue Notifications</span>
                        </label>
                    </div>
                </div>
            </div>
