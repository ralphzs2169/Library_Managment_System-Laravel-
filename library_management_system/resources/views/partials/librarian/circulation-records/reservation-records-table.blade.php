...
<td class="py-3 px-4 whitespace-nowrap text-gray-700">
    <button class="open-reservation-record-details cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-700 hover:bg-gray-800 text-white rounded-lg text-xs font-medium transition-all shadow-sm" data-reservation-record='@json($reservation)' data-action-by="librarian">
