        ...
        <tbody id="penalty-records-real-table-body" class="bg-white divide-y divide-gray-100">
            ...
            <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }} hover:bg-gray-100">
                ...
                <td class="py-3 px-4 whitespace-nowrap text-gray-700">
                    <button class="open-penalty-record-details cursor-pointer inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-700 hover:bg-gray-800 text-white rounded-lg text-xs font-medium transition-all shadow-sm" data-penalty-record='@json($penalty)'>
            ...
            <tr>
                <td colspan="8" class="py-20 px-4 text-center text-gray-500">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-gray-500 text-lg font-medium mb-2">No penalty records found</p>
