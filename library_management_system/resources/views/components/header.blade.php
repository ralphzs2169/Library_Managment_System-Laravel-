...
<header class="bg-primary text-white shadow-lg sticky top-0 z-50 drop-shadow-custom">
    ...
    <div class="flex justify-between items-center h-16">
        ...
        @auth
            <div class="flex items-center space-x-2 relative max-w-[300px]">
              <img 
                    src="{{ asset('build/assets/icons/notification.svg') }}" 
                    alt="Notification Icon" 
                     class="w-10 h-10 rounded-full shrink-0 bg-secondary p-1.5"
                >

                <img 
                    src="{{ asset('build/assets/icons/avatar.svg') }}" 
                    alt="User Icon" 
                     class="w-10 h-10 rounded-full shrink-0 bg-secondary p-1.5"
                >
               ...
               <div class="hidden md:flex flex-col min-w-0">
                ...
                <button id="profileDropdown" class="flex items-center space-x-1 focus:outline-none cursor-pointer shrink-0">
                    <img 
                        src="{{ asset('build/assets/icons/dropdown-white.svg') }}" 
                        alt="Profile Dropdown" 
                        class="hover-scale-lg w-5 h-5"
                    >
                </button>
            </div>
  ...
  <div id="mobile-menu" class="hidden lg:hidden bg-primary border-t border-white border-opacity-10 absolute left-0 right-0 shadow-xl">
    ...
    {{-- ELSE --}}
      <div class="pt-4 space-y-3 border-t border-white border-opacity-30 mt-6">
        <a href="/signup" 
          class="transition-all duration-300 hover:bg-gray-700 hover:text-accent w-full py-3.5 px-4 text-center rounded-lg font-semibold tracking-wide shadow-sm block">
          Sign Up
        </a>
        <a href="/login" 
          class="hover-scale-sm w-full py-3.5 px-4 bg-accent text-black rounded-lg font-bold tracking-wide shadow-md block text-center">
          Login
        </a>
      </div>
