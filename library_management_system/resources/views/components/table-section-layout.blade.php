            ...
            <form method="get" id="filterForm" class="flex flex-col gap-2 w-full mb-4">
                ...
                <div class="flex flex-col md:flex-row gap-3 w-full">
                    ...
                    <div class="flex items-center border border-gray-300 rounded-full px-4 py-2 flex-grow shadow-sm">
                        ...
                        <input type="text" placeholder="Search users by their name..." class="flex-grow px-3 py-1 text-sm outline-none placeholder-gray-400" value="" name="search">
                    </div>
                    <!-- Single date picker -->
                ...
                <div class="flex flex-col md:flex-row gap-3 w-full items-end">
                    ...
                    <button type="button" class="ml-auto px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm w-fit block md:w-auto">
                        Reset Filters
                    </button>
                </div>
            </form>
