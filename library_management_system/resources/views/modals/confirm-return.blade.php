    ...
    <div id="confirm-return-content" class="bg-white rounded-2xl shadow-2xl w-[95%] max-w-2xl my-8 max-h-[90vh] overflow-hidden transform scale-95 opacity-0 transition-all duration-150 flex flex-col">
        ...
        <div class="bg-modal-header drop-shadow-md px-6 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <button id="return-back-to-borrower-profile" class="cursor-pointer text-gray-600 hover:text-gray-800 transition hidden">
                    <img src="{{ asset('build/assets/icons/back-gray.svg') }}" alt="Back" class="w-6 h-6">
                </button>
                <h2 class="text-xl font-semibold text-black">Finalize Return Details</h2>
            </div>
        ...
        <div class="px-6 py-5 overflow-y-auto">
            ...
            <div class="border border-gray-200 rounded-lg p-3 mb-4 flex items-center justify-between">
                ...
                <span id="confirm-return-borrower-role-badge"></span>
            </div>
        ...
        <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
            ...
            <button id="confirm-return-button" class="px-6 py-2.5 bg-secondary-light hover:bg-secondary-light/90 cursor-pointer text-white rounded-lg font-medium transition-all shadow-sm hover:shadow flex items-center gap-2">
