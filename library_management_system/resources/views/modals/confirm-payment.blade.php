            ...
            <div class="bg-white rounded-xl border border-gray-200 p-4 mb-4 relative">
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 space-y-2">
                        <div>
                            <h4 id="confirm-payment-book-title" class="w-[80%] line-clamp-2 text-lg font-bold text-gray-900"></h4>
            ...
            <form id="confirm-payment-form" novalidate>
                ...
                <div>
                    <div class="flex justify-end gap-3 mt-4">
                        ...
                        <button id="confirm-payment-button" type="submit" class="px-6 py-2.5 bg-secondary hover:bg-secondary/90 text-white rounded-lg font-medium transition-all shadow-sm hover:shadow flex items-center gap-2">
