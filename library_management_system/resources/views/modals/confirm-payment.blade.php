<div id="confirm-payment-modal" class="fixed inset-0 flex items-center justify-center bg-background-unfocused hidden bg-opacity-0 z-70 transition-opacity duration-150">
    <div id="confirm-payment-content" class="bg-white rounded-2xl shadow-2xl w-[95%] max-w-2xl my-8 max-h-[90vh] overflow-hidden flex flex-col transform scale-95 opacity-0 transition-all duration-150">
        ...
        <div class="px-6 py-5 overflow-y-auto">
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 space-y-2">
                        ...
                        <div class="grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs">
                            ...
                            <div>
                                <p class="text-gray-500 uppercase tracking-wide">Amount</p>
            ...
            <form id="confirm-payment-form" class="bg-white rounded-xl border border-gray-200 p-4 mb-4">
                @csrf
        ...
        <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
            <button id="cancel-payment-button" class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition-all shadow-sm">
                Cancel
            </button>
            <button id="confirm-payment-button" class="px-6 py-2.5 bg-accent hover:bg-accent/90 text-white rounded-lg font-medium transition-all shadow-sm hover:shadow flex items-center gap-2">
