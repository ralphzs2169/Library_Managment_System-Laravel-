...
<head>
    ...
    <link rel="icon" type="image/png" href="/Library_management_System/public/assets/images/logo.png">
   
    {{-- <link rel="stylesheet" href="/Library_management_Systempublic/css/components/loaders.css"> --}}
...
<body>
        ...
        <div class="bg-white p-10 rounded-2xl shadow-lg w-full max-w-2xl">
            ...
            <div class="mt-4 text-center">
                <p class="text-xs text-gray-600">Already Have an Account? 
                    {{-- <a href="<?php echo BASE_URL ?>views/auth/login.php" class="text-accent font-medium underline">Login Now</a> --}}
                </p>
            </div>
        </div>
    </div>
    ...
    {{-- <script src="library_management_systemtem/node_modules/sweetalert2/dist/sweetalert2.all.min.js"></script> --}}
