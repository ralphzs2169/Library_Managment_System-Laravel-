...
class SettingsService
{
    ...
    public function detectChanges(Request $request)
    {
        ...
        $fields = [
            ...
            'student_duration' => 'renewing.student_duration',
            'teacher_duration' => 'renewing.teacher_duration',
    ...
    public function updateSettings(Request $request)
    {
        return DB::transaction(function () use ($request) {
            $settings = [
                ...
                'renewing.student_duration' => $request->input('student_duration'),
                'renewing.teacher_duration' => $request->input('teacher_duration'),
